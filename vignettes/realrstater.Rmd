...
The objective of the `RealEstateR` package is extracting some of the information that is available in the Zillow's API, and making it suitable for data analysis in R.
